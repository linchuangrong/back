...
(function() {
	...
	app.addController("companyCertificationDetailCtrl", companyCertificationDetailCtrl);
	companyCertificationDetailCtrl.$inject = ['$rootScope'];

	function companyCertificationDetailCtrl($rootScope) {
		var vm = this;
