...
(function() {
	...
	app.addController("companyCertificationCtrl", companyCertificationCtrl);
	companyCertificationCtrl.$inject = ['$rootScope', '$window'];

	function companyCertificationCtrl($rootScope, $window) {
		var vm = this;
