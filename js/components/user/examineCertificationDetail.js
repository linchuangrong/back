...
(function() {
	...
	app.addController("examineCertificationDetailCtrl", examineCertificationDetailCtrl);
	examineCertificationDetailCtrl.$inject = ['$rootScope'];

	function examineCertificationDetailCtrl($rootScope) {
		var vm = this;
