...
(function() {
	...
	app.addController("certificationCtrl", certificationCtrl);
	certificationCtrl.$inject = ['$rootScope', '$window', '$timeout'];

	function certificationCtrl($rootScope, $window, $timeout) {
		var vm = this;
