...
(function() {
    ...
    app.addController("examineReleaseListCtrl", examineReleaseListCtrl);
    examineReleaseListCtrl.$inject = ['$rootScope', '$window'];

    function examineReleaseListCtrl($rootScope, $window) {
        var vm = this;
        $rootScope.title = "进行中";
