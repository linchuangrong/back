...
(function() {
	...
	app.addController("crowdfundExamineListCtrl", crowdfundExamineListCtrl);
	crowdfundExamineListCtrl.$inject = ['$rootScope', '$window'];

	function crowdfundExamineListCtrl($rootScope, $window) {
		var vm = this;
		$rootScope.title = "待审核筹款";
