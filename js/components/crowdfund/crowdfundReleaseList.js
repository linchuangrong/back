...
(function() {
	...
	app.addController("crowdfundReleaseListCtrl", crowdfundReleaseListCtrl);
	crowdfundReleaseListCtrl.$inject = ['$rootScope', '$window'];

	function crowdfundReleaseListCtrl($rootScope, $window) {
		var vm = this;
		$rootScope.title = "已上线筹款";
