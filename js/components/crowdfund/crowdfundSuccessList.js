...
(function() {
	...
	app.addController("crowdfundSuccessListCtrl", crowdfundSuccessListCtrl);
	crowdfundSuccessListCtrl.$inject = ['$rootScope', '$window'];

	function crowdfundSuccessListCtrl($rootScope, $window) {
		var vm = this;
		$rootScope.title = "已成功筹款";
